...
var notiHook = [
  {
    ...
    notiPayload: [
      ...
      {
        payloadValue: '40', // so if MM issues notification "CLOCK_MINUTE" with payload "20", the mqtt-messages should be sent to the topics - could be a list of such messages like in example further: 2 topics/messages)
        notiMqttCmd: ["Command 1", "Command 2"]
      },
      {
        payloadValue: '50', // so if MM issues notification "CLOCK_MINUTE" with payload "20", the mqtt-messages should be sent to the topics - could be a list of such messages like in example further: 2 topics/messages)
        notiMqttCmd: ["Command 1", "Command 2"]
      },
      {
        payloadValue: '60', // so if MM issues notification "CLOCK_MINUTE" with payload "20", the mqtt-messages should be sent to the topics - could be a list of such messages like in example further: 2 topics/messages)
        notiMqttCmd: ["Command 1", "Command 2"]
      },
      {
        payloadValue: '00', // so if MM issues notification "CLOCK_MINUTE" with payload "20", the mqtt-messages should be sent to the topics - could be a list of such messages like in example further: 2 topics/messages)
        notiMqttCmd: ["Command 1", "Command 2"]
      },
    ],
  },
